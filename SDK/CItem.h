...
public:
	...
	//bool isShovelingTool(void){
	//	if (itemId == ) return true;                                                                                       // Diamond Shovel 
	//	if (itemId == 256) return true;                                                                                       // Iron Shovel 
	//	if (itemId == 273) return true;                                                                                       // Stone Shovel 
	//	if (itemId == 269) return true;                                                                                       // Wood Shovel 
	//	return false;	
	//}
	//bool isWoodworkingTool(void){
	//	if (itemId == 279) return true;                                                                                      // Diamond Axe 
	//	if (itemId == 258) return true;                                                                                      // Iron Axe 
	//	if (itemId == 275) return true;                                                                                      // Stone Axe 
	//	if (itemId == 271) return true;                                                                                      // Wood Axe  
	//	return false;
	//}
	bool isBlock(void) {
